...
const URL = "https://www.footmercato.net/espagne/liga/classement";
const FILE_PATH = "./laliga_standings.json";

async function fetchLaLigaStandings() {
  try {
    ...
    console.log("✅ La Liga standings saved");
  } catch (err) {
    console.error("❌ Error fetching standings:", err.message);
  }
}

export default fetchLaLigaStandings;
