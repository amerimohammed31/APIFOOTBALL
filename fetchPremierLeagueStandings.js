...
const URL = "https://www.footmercato.net/angleterre/premier-league/classement";
const FILE_PATH = "./premierleague_standings.json";
...
async function fetchPremierLeagueStandings() {
  try {
    ...
    console.log("✅ Premier League standings saved");
  } catch (err) {
    console.error("❌ Error fetching Premier League:", err.message);
  }
}

export default fetchPremierLeagueStandings;
