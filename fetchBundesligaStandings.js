...
const URL = "https://www.footmercato.net/allemagne/bundesliga/classement";
const FILE_PATH = "./bundesliga_standings.json";

async function fetchBundesligaStandings() {
  try {
    ...
    console.log("✅ Bundesliga standings saved");
  } catch (err) {
    console.error("❌ Error fetching Bundesliga:", err.message);
  }
}

export default fetchBundesligaStandings;
