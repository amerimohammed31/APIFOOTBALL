...
const URL = "https://www.footmercato.net/italie/serie-a/classement";
const FILE_PATH = "./seriea_standings.json";
...
async function fetchSerieAStandings() {
  try {
    ...
    console.log("✅ Serie A standings saved");
  } catch (err) {
    console.error("❌ Error fetching Serie A:", err.message);
  }
}

export default fetchSerieAStandings;
